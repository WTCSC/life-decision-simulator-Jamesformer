...
if wake == "yes":
    ...
    # hero/imprisoned hero/government start
    if school == "yes":
        if wake == "yes":
            ...
            # dictator/partially evil route/burned world
    if school == "no":
        ...
        if school == "no":
            ...
            if drastic == "no":
                print("because of your inaction you were captured and somehow being held in a prototype containment cell that suppresses the powers of gods and are sentenced to be locked in that cell forever. Your path ends here you got the PARTIALLY EVIL ending")
                     ...
                     if devolve == "yes":
                         print("you devolve the leaders and spec ops minds into those of neanderthals and since their are no more political opponents to object to your overwhelming power except the people. They are actively organizing coup de'tat's against your control.")
                     if devolve == "no":
                            print("you are filled with enough lead to block a small nuclear bombs worth of radiation you have been killed by the spec ops teams. you got the ALT PARTIAL EVIL ending")
                     elif devolve == "yes":
                                suppress = input("will you forever suppress the people and ensure your grip across the world: ")
                                if suppress == "yes":
                                     print("you use your power to permanently devolve all technology and human knowledge to those of the stone age and you punish those who resist to your power. You establish an iron grip that doesn't relent for a 1000 years. You got the DICTATOR ending")
                                if suppress == "no":
                                     print("you distance yourself from the public eye and let the world burn with no leaders left. You got the BURNED WORLD ending")
    # imprisoned hero/hero/fairly pathetic/government
    elif school == "yes":
             savior = input("will you us your powers for good: ")
             if savior == "yes":
                  print("you use your amazing powers to turn the gloinks into their docile version. You are hailed a hero for your actions but their are people calling your actions cruel. ")
             if savior == "no":
                  print("you cower at the sight of the gloinks and hide from them. you are found and torn limb from limb. You got the FAIRLY PATHETIC ending")
             elif savior == "yes":
                  address = input("will you address these concerns: ")
                  if address == "yes":
                       print("you address these concerns but it backfires and spreads the opinion that what you did was against the laws of nature spreads like wildfire and the government is now looking into you and gives you a ultimatum to either work for the department of defense or be imprisoned")
                  if address == "no":
                       print("you do not address the public on this and the concerns seem to fade away after a while. after awhile the government contacts you about joining the department of defense as their propretor of freedom")
                  elif address == "yes":
                       imprisoned = input("do you join the government: ")
                       if imprisoned == "yes":
                            print("you join the department of defense and are a puppet of the government with no real free will every action is monitored. You are effectively a slave to the USA. you got the GOVERNMENT ending")
                       if imprisoned == "no":
                            print("because of your refusal you are detained and confined in a special cell that nullifies your powers. You got the IMPRISONED HERO ending")
                  if address == "no":
                       hero = input("will you join the government: ")
                       if hero == "yes":
                            print("you join the department of defense and are hailed a protector of american values and your likeness is used in government propaganda that is everywhere. You got the ALT GOVERNMENT ending")
                       if hero == "no":
                            print("you decline the governments offer and decide to become a traveling vigilante for solving areas of conflict across the world. You got the HERO ending.")
if wake == "no":
