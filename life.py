...
if wake == "yes":
    ...
    if school == "no":
        ...
        if school == "no":
            ...
            if drastic == "yes":
                print("you in desperation use your powers over time to turn everyone in the continental united states of america into babies and because of that action you become the de facto president of the united states. the other leaders of the world worried ")